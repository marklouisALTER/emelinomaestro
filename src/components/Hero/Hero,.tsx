...
export const Hero:React.FC = () => {
    return (
        <div className="w-full h-[601px] relative">
            <img
            ...
            <h1 className="text-white text-2xl md:text-3xl lg:text-8xl mb-2">Lorem Ipsum</h1>
            ...
            <button className="mt-4 px-4 py-2 bg-[#5B94E9B5] hover:bg-primary font-bold text-2xl text-white rounded w-[245px] h-[55px] font-monts ">
                See More
            </button>
            <div className="mt-4 space-x-4 flex ">
                <div className="rounded-md cursor-pointer text-white bg-primary hover:bg-primaryDark flex items-center justify-center py-[12px] px-[18px] w-[50px] h-[50px]">
                <a href="#">
                ...
                <div className="rounded-md cursor-pointer text-white bg-[#FF0000] hover:bg-[#B20000] flex items-center justify-center py-[12px] px-[18px] w-[50px] h-[50px]">
