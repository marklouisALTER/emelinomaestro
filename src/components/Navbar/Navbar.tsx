...
export const Navbar:React.FC = () => {
  return (
    ...
    <div className='bg-primary sticky top-0 z-[99] w-full'>      
      <div className='flex items-center py-[8px] px-5 lg:px-14 justify-between'>
      ...
      <div className="sticky top-[20rem] z-40 hidden lg:block">
         <div className='absolute flex flex-col gap-10 left-10'>
          <div 
            ...
            className="rounded-md cursor-pointer text-white transition-all ease-in-out bg-primary hover:bg-primaryDark 
          flex items-center justify-center py-[12px] px-[18px] w-[50px] h-[50px] hover:ml-4">
            <a href="#">
          ...
          <div 
            ...
            className="rounded-md cursor-pointer text-white transition-all ease-in-out bg-[#FF0000] hover:bg-[#B20000] 
            flex items-center justify-center py-[12px] px-[18px] w-[50px] h-[50px] hover:ml-4">
